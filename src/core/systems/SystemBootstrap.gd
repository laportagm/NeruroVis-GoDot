...
func _initialize_knowledge_base(main_scene: Node3D) -> bool:
	...
	var script_path = "res://src/core/knowledge/AnatomicalKnowledgeDatabase.gd"
...
func _initialize_neural_net(main_scene: Node3D) -> bool:
	...
	var script_path = "res://src/core/systems/BrainVisualizationCore.gd"
	var script_resource = _load_script(script_path)
	if not script_resource:
		return false
...
func _initialize_model_switcher(main_scene: Node3D) -> bool:
	...
	var script_path = "res://src/core/models/ModelVisibilityManager.gd"
	var script_resource = _load_script(script_path)
	if not script_resource:
		return false
...
func _initialize_model_coordinator(main_scene: Node3D) -> bool:
	...
	var script_path = "res://src/core/models/ModelRegistry.gd"
	var script_resource = _load_script(script_path)
	if not script_resource:
		return false
...
func _initialize_selection_manager(main_scene: Node3D) -> bool:
	...
	var script_path = "res://src/core/interaction/BrainStructureSelectionManager.gd"
	var script_resource = _load_script(script_path)
	if not script_resource:
		return false
...
func _initialize_camera_controller(main_scene: Node3D) -> bool:
	...
	var script_path = "res://src/core/interaction/CameraBehaviorController.gd"
	var script_resource = _load_script(script_path)
	if not script_resource:
		return false
...
func _create_loading_overlay(main_scene: Node3D):
	...
	var script_path = "res://src/ui/panels/LoadingOverlay.gd"
	var script_resource = _load_script(script_path)
	if not script_resource:
