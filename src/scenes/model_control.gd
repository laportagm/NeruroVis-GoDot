...
# UI node references - populated dynamically
...
func _create_models_display_area(parent: Control) -> void:
	...
	if not models_container:
		push_error("[ENHANCED_MODEL_PANEL] Failed to create models_container")
	else:
		print("[ENHANCED_MODEL_PANEL] models_container created successfully")
