...
var MultiStructureSelectionManagerScript = load("res://src/core/interaction/MultiStructureSelectionManager.gd")
var CameraBehaviorControllerScript = load("res://src/core/interaction/CameraBehaviorController.gd")
var ModelCoordinatorScene = load("res://src/core/models/ModelRegistry.gd")
var ComparativeInfoPanelScript = load("res://src/ui/panels/ComparativeInfoPanel.gd")
# UIThemeManager is now available as autoload

# === NEW FOUNDATION LAYER ===
var FeatureFlags = load("res://src/core/features/FeatureFlags.gd")
var ComponentRegistry = load("res://src/ui/core/ComponentRegistry.gd")
var ComponentStateManager = load("res://src/ui/state/ComponentStateManager.gd")

# UI Component System preloads - PROGRESSIVE ENABLEMENT
var SafeAutoloadAccess = load("res://src/ui/components/core/SafeAutoloadAccess.gd")
var BaseUIComponent = load("res://src/ui/components/core/BaseUIComponent.gd")
var UIComponentFactory = load("res://src/ui/components/core/UIComponentFactory.gd")
var ResponsiveComponent = load("res://src/ui/components/core/ResponsiveComponent_Safe.gd")
...
func _apply_modern_theme() -> void:
    ...
    var theme_manager = load("res://src/ui/panels/UIThemeManager.gd")
...
func _on_structure_selected(structure_name: String, _mesh: MeshInstance3D) -> void:
    ...
    load("res://src/ui/panels/UIThemeManager.gd").animate_fade_text_change(object_name_label, "Selected: " + structure_name)
...
func _on_theme_toggle_pressed() -> void:
    ...
    var theme_manager = preload("res://src/ui/panels/UIThemeManager.gd")
...
func _debug_demo_foundation() -> void:
    ...
    var FoundationDemo = preload("res://src/ui/integration/FoundationDemo.gd")
...
func _show_gemini_setup_dialog() -> void:
    ...
    var dialog_scene = load("res://src/scenes/ui/dialogs/gemini_setup.tscn")
    if not dialog_scene:
