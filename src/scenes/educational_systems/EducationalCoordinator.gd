...
func _setup_selection_system() -> void:
	...
	var SelectionSystemScene = load("res://src/scenes/visualization_systems/SelectionSystem.tscn")
...
func _setup_brain_visualization() -> void:
	...
	var BrainVisualizationScene = load("res://src/scenes/visualization_systems/BrainVisualization.tscn")
...
func _setup_educational_ui() -> void:
	...
	var EducationalUIScene = load("res://src/scenes/interface_systems/EducationalUI.tscn")
