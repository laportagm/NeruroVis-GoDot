...
var _prev_camera_distance: float = 10.0

# Settings
var debug_material: StandardMaterial3D
var debug_font: Font
var text_color: Color = Color(1, 1, 0)  # Yellow
var ray_color: Color = Color(1, 0, 0)  # Red
var collision_color: Color = Color(0, 1, 0, 0.3)  # Green, semi-transparent

# Debug objects
var debug_objects: Array = []
var mesh_highlights: Dictionary = {}
...
func _init() -> void:
	...
	debug_font = ThemeDB.fallback_font if ThemeDB.has_method("fallback_font") else null
...
static func label_all_nodes(parent: Node3D, recursive: bool = true, filter_class: String = "") -> void:
	...
	for child in parent.get_children():
		if child is Node3D:
			var add_label = filter_class.is_empty() or child.get_class() == filter_class
