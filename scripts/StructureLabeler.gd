...
func set_labels_visibility(is_visible: bool) -> void:
	if labels_visible != is_visible:
		labels_visible = is_visible
		...
		# Emit signal for UI updates
		emit_signal("labels_visibility_changed", is_visible)
		print("Structure labels visibility set to: " + str(is_visible))
