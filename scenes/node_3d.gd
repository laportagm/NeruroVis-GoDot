...
const CameraControllerScene = preload("res://scripts/CameraController.gd")
const ModelCoordinatorScene = preload("res://scripts/ModelCoordinator.gd")
...
var model_coordinator: ModelCoordinator = null
...
func _connect_selection_signals() -> void:
	if selection_manager:
		...
		print("Warning: SelectionManager node not found")
...
func _setup_camera_controller() -> void:
	if camera_controller:
		...
		print("Warning: CameraController node not found")
	...
	if event is InputEventMouseButton:
		...
		if event.button_index == MOUSE_BUTTON_LEFT and event.pressed:
			if selection_manager:
				...
				print("Warning: SelectionManager not available")
			get_viewport().set_input_as_handled()
